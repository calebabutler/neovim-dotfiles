...
-- Basic vim settings for tabs and whitespace
vim.o.tabstop = 8
vim.o.softtabstop = 4
vim.o.shiftwidth = 4
...
-- Additional vim settings for numbers and jj escape
vim.o.number = true
...
-- Configure lspconfig with nvim-cmp
